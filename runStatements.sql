...
SELECT C.id_cliente AS id_cliente, C.nombre AS nombre_cliente, EE.id_edificio_estacionamiento AS id_edificio, SUM(P.monto) AS monto_total_gastado
FROM Cliente C
	...
	GROUP BY C.id_cliente, C.nombre, EE.id_edificio_estacionamiento                                              --Se agrupa por cliente y edificio.
